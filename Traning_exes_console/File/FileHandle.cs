...
namespace Traning_exes_console.File
{
    internal class FileHandle
    {
        ...
        /// <summary>
        ///	Nếu số bị sai format -> in: Format không đúng: ... (... là chuỗi bị sai)
	    /// Nếu số bị vượt quá giới hạn của số -> coi như số = -1
	    /// Nếu có bất kỳ lỗi gì khác xảy ra(File không đọc được,…) -> In thông báo: Lỗi không xử lý tiếp ra màn hình và dừng
